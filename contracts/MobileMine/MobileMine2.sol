...
//Active users' information.
  ...
  MinerRegistry MinerReg;
    //Only not paid miner  can modify. 
     modifier onlyNoPaidMiner {
        MinerRegTime=MinerReg.MinerRegistryTime (msg.sender);
       require (MinerRegTime+86400>now&&Miners[msg.sender]+86400<now);
         _;
      }
...
//Define the contract can receive mining reward foundation.
  ...
  //Set Address of MinerRegisty contract.
...
/* Miner mine function, modify miner's status*/
  function Mine() onlyNoPaidMiner public returns (bool success){
       //Inqury the MinerRegistry contract to aquire the miner's Registrytime.
       //MinerRegTime=MinerReg.MinerRegistryTime (msg.sender);
